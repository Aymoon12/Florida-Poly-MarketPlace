          ...
          >
            ...
            <Container maxWidth="lg" sx={{ position: 'relative', height: '100%', display: 'flex', alignItems: 'center' }}>
              <Box sx={{ maxWidth: {xs: '100%', md: '50%'}, zIndex: 2, px: {xs: 2, sm: 0} }}>
                <Typography variant="h3" sx={{ color: "#fff", fontWeight: 700, mb: 2, fontSize: {xs: '1.75rem', sm: '2.5rem', md: '2.75rem'} }}>
                  Welcome to PolyMart
                </Typography>
                <Typography variant="h6" sx={{ color: "#fff", fontWeight: 500, mb: 3, opacity: 0.9, fontSize: {xs: '1rem', sm: '1.25rem'} }}>
