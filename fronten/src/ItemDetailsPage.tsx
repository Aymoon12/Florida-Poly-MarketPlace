...
const ItemDetailsPage: React.FC = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      {/* Breadcrumbs */}
      <Breadcrumbs sx={{ mb: 3 }}>
        <MuiLink component="button" color="inherit" onClick={() => navigate('/home')} sx={{ textDecoration: 'none' }}>
          Home
        </MuiLink>
        <MuiLink component="button" color="inherit" onClick={() => navigate('/listings')} sx={{ textDecoration: 'none' }}>
          Listings
        </MuiLink>
        <MuiLink component="button" color="inherit" onClick={() => navigate(`/search?q=${encodeURIComponent(item.category)}`)} sx={{ textDecoration: 'none' }}>
          {item.category}
        </MuiLink>
                ...
                <List disablePadding>
                  <ListItem disablePadding sx={{ py: 1 }}>
                    ...
                    <ListItemText 
                      ...
                      secondaryTypographyProps={{ variant: 'body1', fontWeight: 500, color: '#2d3748' }}
                    />
                  </ListItem>
